  ...
  return (
    <div className="flex gap-3">
      <button 
        ...
        className="flex-1 px-4 py-3 bg-secondary-500 hover:bg-secondary-600 text-white rounded-xl font-semibold text-sm hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
      >
        <span>📊</span>
        <span>CSV</span>
      </button>
      <button 
        ...
        disabled={!history || history.length === 0}
        className="flex-1 px-4 py-3 bg-primary-500 hover:bg-primary-600 text-white rounded-xl font-semibold text-sm hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
      >
        <span>📄</span>
        <span>JSON</span>
      </button>
